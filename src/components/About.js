                ...
                <Row xs={1} md={2}>
                    ...
                    <Col className="px-lg-5 mb-2">
                        <div className="px-lg-5 about-text text-justify">
                            ...
                            <p>
                                A Full Stack Developer from Dindigul.
                                Have an interest in learning new tchnologies and always open to new directions of programming.
                            </p>
                            <p>
                                I'm Richard selvaraj P, I completed my Bachelor's Degree and residue at Dindigul. I am a person who has a passion in Techologies.
                                I have been coding for around 6 months now.I look back to those days where it all begans from black screen to beautiful websites and Web applications now a days and that's how far i have grown now.I love to create FullStack applications using MERN stack perferably.I have a dream to master all the Technologies and to be the best developer in the world and now I am working toward it!.
